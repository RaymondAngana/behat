...
PROJECT_NAME = drupal
drush_alias = @drupal.local
uuid = "4d940caa-9d31-4f7e-bb5c-b4fb5bd86909"
SITE_NAME = "Drupal"
...
initialize-db:
	...
	@docker-compose exec php $(project_root)/bin/drush $(drush_alias) si demo_umami --db-url=mysql://drupal:drupal@db/drupal --account-name=admin --account-pass=drupaladm1n --site-name=$(SITE_NAME) -y
